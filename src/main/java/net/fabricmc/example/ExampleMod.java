...
public class ExampleMod implements ModInitializer {
	...
	public static final MinecraftFoodItem CUSTOM_ITEM = new MinecraftFoodItem(
			new Item.Settings().maxCount(64).fireproof().group(ItemGroup.MISC)
					.food(new FoodComponent.Builder().hunger(1).saturationModifier(0.3F).alwaysEdible().build()));
